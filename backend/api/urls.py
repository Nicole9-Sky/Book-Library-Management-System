...
from .views import ReaderViewSet, BookViewSet, get_reader_by_id, update_reader_bag, checkout_books,add_to_bag, get_checked_out_books, return_book, returns_list
...
urlpatterns = [
    ...
    path('returns/', returns_list, name='returns_list'),
]
